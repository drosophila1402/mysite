...
class NewsCategory(SortableMixin):
    name = models.CharField(max_length=225)
    the_order = models.PositiveIntegerField(default=0, editable=False, db_index=True)
...
class News(models.Model):
    ...
    category = models.ManyToManyField(NewsCategory, verbose_name='カテゴリ', blank=True)
...
class Comment(models.Model):
    ...
    post = models.ForeignKey('ec.News', on_delete=models.CASCADE, related_name='comments')
    approve = models.BooleanField('非表示にする', default=False)
